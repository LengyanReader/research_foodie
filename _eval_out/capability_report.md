...
> Generated `2026-09-20T15:56:55` by `tools.eval.capability_report`. Reads cached `_eval_out/` artifacts; every figure keeps its own `as of` date below.
...
- **Tool ledger** (`as of 2026-09-20T15:56:55`):
...
- **Feedback corpus:** 6 rows · gold share 0.0 (quota_ok=True, enforced=False)
...
---
*Provenance: generated `2026-09-20T15:56:55` · profile `[profile free-opencode] draft=opencode/big-pickle, qa=opencode/big-pickle, judge=opencode/big-pickle` · reproduce: `python -m tools.eval.capability_report`*
