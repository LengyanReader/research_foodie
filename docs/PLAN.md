...
| 22 | **Track C part 3 — QA panel expansion (Session 19):** Qasper +3 papers (`1910.09982`, `1910.06036`, `1908.06267`; 1910.06036 needed sub-window 0-3+4-5 workaround); **SciQ provided-context `ctx` routing** (`check_answer(..., require_cite=False)`, `SQ-1..5` from the `support` sentence); PubMedQA yes/no abstracts (PQ-1..5); one-command corpus adder `add_paper.py` verified on a 12-pp paper (QA-11/12, precision anchors); QA-scorer truncated-json recovery fix | done | **QA-8/9/10 c 5 · g 5 · gold 3/3 each** · **SQ-1..5 c 5 · gold 1/1 each (g 3-5)** · **PQ-2/3/4 c 4, PQ-1/5 c 2 (yes/no judgment leak)** · **QA-11/12 c 5 · g 5 · gold 1/1 each** → **panel n=22: correctness 4.41 · groundedness 4.41 · 19/22**; extract/context paths **13/13**; QA-3 (taxonomy) + PubMedQA yes/no remain imperfect cells |
